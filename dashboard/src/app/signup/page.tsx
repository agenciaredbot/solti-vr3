      ...
      <div className="min-h-screen flex items-center justify-center bg-zinc-950">
        <div className="w-full max-w-md text-center space-y-4 p-8">
          ...
          <p className="text-zinc-400">
            Enviamos un enlace de confirmacion a <span className="text-white">{email}</span>.
    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-950">
      <div className="w-full max-w-lg space-y-8 p-8">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-white">Unete a Solti</h1>
          <p className="mt-2 text-zinc-400">
            {step === 'plan' ? 'Elige tu plan para empezar' : 'Crea tu cuenta'}
          </p>
        </div>
        ...
        {step === 'plan' ? (
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full rounded-lg bg-emerald-600 px-4 py-3 font-medium text-white hover:bg-emerald-500 transition-colors"
            >
          ...
          <div className="space-y-6">
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full rounded-lg bg-emerald-600 px-4 py-3 font-medium text-white hover:bg-emerald-500 transition-colors disabled:opacity-50"
              >
